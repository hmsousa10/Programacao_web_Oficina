...
function openEditViatura(id) {
  ...
  document.getElementById('viat-vin').value        = v.vin || '';
...
async function submitViatura(e) {
  ...
  const payload = {
    ...
    vin:           document.getElementById('viat-vin').value.trim() || null,
    marca:         document.getElementById('viat-marca').value.trim(),
    modelo:        document.getElementById('viat-modelo').value.trim(),
    ano:           document.getElementById('viat-ano').value ? parseInt(document.getElementById('viat-ano').value) : null,
    combustivel:   document.getElementById('viat-combustivel').value || null,
    quilometragem: document.getElementById('viat-km').value ? parseInt(document.getElementById('viat-km').value) : null,
    cor:           document.getElementById('viat-cor').value.trim() || null,
    observacoes:   document.getElementById('viat-obs').value.trim() || null,
    clienteId:     parseInt(document.getElementById('viat-cliente').value),
  };
  try {
    if (id) {
